...
// Set display order every page load
$database->execute("UPDATE modules SET order_index = 1 WHERE module_name LIKE '%Zero%'");
$database->execute("UPDATE modules SET order_index = 2 WHERE module_name = 'Counting Numbers 1-9'");
$database->execute("UPDATE modules SET order_index = 3 WHERE module_name LIKE '%Recognising%Numbers%1-9%' AND module_name NOT LIKE '%Counting%'");
