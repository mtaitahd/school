...
try {
    ...
    if (!empty($check_columns)) {
        ...
        echo "</div>";
        echo "<p><a href='../teacher/dashboard'>Go to Teacher Dashboard</a></p>";
        exit;
    }
    ...
    echo "<p style='color: green;'>Ã¢Å“â€œ parent_phone column added</p>";
    ...
    echo "<p style='color: green;'>Ã¢Å“â€œ claim_code column added</p>";
    ...
    echo "<p style='color: green;'>Ã¢Å“â€œ parent_claimed column added</p>";
    ...
    echo "<p style='color: green;'>Ã¢Å“â€œ claim_code_created_at column added</p>";
    ...
    echo "<p style='color: green;'>Ã¢Å“â€œ Indexes added</p>";
