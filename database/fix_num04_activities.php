...
$acts[] = [$c, 'check', 5, 'Find 11 and 12', 'Tap the correct number.', act_json('number_identification', ['min'=>11,'max'=>15,'poolSize'=>5,'target_number'=>12,'difficulty'=>1], 'Find number 12!', 'Identify 12.', 'Which number is 12?', [11,12,13,14,15], 12, 'Yes! 12!', 'easy', 1)];
...
$acts[] = [$c, 'assessment', 7, 'Quiz: 11 and 12', 'Show what you know!', act_json('number_identification', ['min'=>11,'max'=>15,'poolSize'=>5,'target_number'=>11,'difficulty'=>1], 'Find 11!', 'Assess knowledge.', 'Which number is 11?', [11,12,13,14,15], 11, 'You know 11 and 12!', 'easy', 3)];
...
$acts[] = [$c, 'check', 5, 'Find 13 and 14', 'Tap the correct number.', act_json('number_identification', ['min'=>11,'max'=>15,'poolSize'=>5,'target_number'=>14,'difficulty'=>1], 'Find number 14!', 'Identify 14.', 'Which number is 14?', [11,12,13,14,15], 14, 'Yes! 14!', 'easy', 1)];
...
$acts[] = [$c, 'assessment', 7, 'Quiz: 13 and 14', 'Show what you know!', act_json('number_identification', ['min'=>11,'max'=>15,'poolSize'=>5,'target_number'=>13,'difficulty'=>1], 'Find 13!', 'Assess knowledge.', 'Which number is 13?', [11,12,13,14,15], 13, 'You know 13 and 14!', 'easy', 3)];
...
$acts[] = [$c, 'check', 5, 'Find 15 and 16', 'Tap the correct number.', act_json('number_identification', ['min'=>13,'max'=>17,'poolSize'=>5,'target_number'=>16,'difficulty'=>1], 'Find number 16!', 'Identify 16.', 'Which number is 16?', [13,14,15,16,17], 16, 'Yes! 16!', 'easy', 1)];
...
$acts[] = [$c, 'assessment', 7, 'Quiz: 15 and 16', 'Show what you know!', act_json('number_identification', ['min'=>13,'max'=>17,'poolSize'=>5,'target_number'=>15,'difficulty'=>1], 'Find 15!', 'Assess knowledge.', 'Which number is 15?', [13,14,15,16,17], 15, 'You know 15 and 16!', 'easy', 3)];
...
$acts[] = [$c, 'check', 5, 'Find 17 and 18', 'Tap the correct number.', act_json('number_identification', ['min'=>15,'max'=>19,'poolSize'=>5,'target_number'=>18,'difficulty'=>1], 'Find number 18!', 'Identify 18.', 'Which number is 18?', [15,16,17,18,19], 18, 'Yes! 18!', 'easy', 1)];
...
$acts[] = [$c, 'assessment', 7, 'Quiz: 17 and 18', 'Show what you know!', act_json('number_identification', ['min'=>15,'max'=>19,'poolSize'=>5,'target_number'=>17,'difficulty'=>1], 'Find 17!', 'Assess knowledge.', 'Which number is 17?', [15,16,17,18,19], 17, 'You know 17 and 18!', 'easy', 3)];
...
$acts[] = [$c, 'check', 5, 'Find 19 and 20', 'Tap the correct number.', act_json('number_identification', ['min'=>17,'max'=>20,'poolSize'=>4,'target_number'=>20,'difficulty'=>1], 'Find number 20!', 'Identify 20.', 'Which number is 20?', [17,18,19,20], 20, 'Yes! 20!', 'easy', 1)];
...
$acts[] = [$c, 'assessment', 7, 'Quiz: 19 and 20', 'Show what you know!', act_json('number_identification', ['min'=>17,'max'=>20,'poolSize'=>4,'target_number'=>19,'difficulty'=>1], 'Find 19!', 'Assess knowledge.', 'Which number is 19?', [17,18,19,20], 19, 'You know 19 and 20!', 'easy', 3)];
...
$acts[] = [$c, 'assessment', 7, 'Game Quiz', 'Show your counting skills!', act_json('number_identification', ['min'=>11,'max'=>20,'poolSize'=>5,'target_number'=>18,'difficulty'=>2], 'Find number 18!', 'Assess knowledge.', 'Which number is 18?', [16,17,18,19,20], 18, 'You know your numbers!', 'easy', 3)];
...
$acts[] = [$c, 'assessment', 7, 'Final Quiz: 11–20', 'The final test!', act_json('number_identification', ['min'=>11,'max'=>20,'poolSize'=>5,'target_number'=>17,'difficulty'=>3], 'Final quiz!', 'Final assessment.', 'Find number 17.', [15,16,17,18,19], 17, 'You mastered 11–20!', 'easy', 5)];
