    ...
    <div class="col-lg-10 col-xl-8">
        ...
        <form method="POST" id="paymentForm">
            ...
            <h6 class="fw-bold mb-3" style="color:#1e293b;">
                <i class="fas fa-tag me-2 text-primary"></i>Choose Payment Type
            </h6>
            <div class="row g-3 mb-4">
                <div class="col-6">
                    <div class="type-card active d-flex flex-column align-items-center justify-content-center" onclick="selectType(this, 'subscription')">
                ...
                <div class="col-6">
                    <div class="type-card d-flex flex-column align-items-center justify-content-center" onclick="selectType(this, 'wallet_topup')">
            ...
            <div class="row g-3 mb-4">
                ...
                <!-- Card Payment Card -->
                <div class="col-md-4">
                    <div class="method-card d-flex flex-column align-items-start" onclick="openCardModal()">
...
function selectType(el, type) {
    ...
    // Toggle amount fields in modals
